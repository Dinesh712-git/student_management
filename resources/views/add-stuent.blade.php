        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 flex justify-center items-center flex-col">
                    ...
                    <form class="w-full max-w-lg" action="/create-student" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3 mb-6 md:mb-0">
                                ...
                                <input
                                    ...
                                    name="name" type="text" placeholder="Name Here">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-2">
                            <div class="w-full  px-3 mb-6 md:mb-0">
                                ...
                                <input
                                    ...
                                    name="age" type="text" placeholder="Age Here">
                            </div>
                        ...
                        <div class="mt-6 flex items-center justify-end gap-x-6">
                            ...
                            <div class="flex justify-center">
                                <button type="submit"
                                    class="custom-width rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 mx-auto">Save</button>
                            </div>
